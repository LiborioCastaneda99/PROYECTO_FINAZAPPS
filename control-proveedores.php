...
<head>
  ...
  <title>CONTROL DE DATOS PROVEEDORES | FINAZAPPS</title>
...
<div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-dialog-centered" role="document">
   <div class="modal-content">
     <div class="modal-header">
      <h5 class="modal-title text-center">Agregar Proveedores</h5>
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">      
      </button>
    </div>
    <div class="modal-body">
     <form class="form p-2 mt-2">
      ...
      <div class="form-group text-left">
        ...
        <input type="hidden" name="" id="tipo_clie_prov" value="Proveedor" class="form form-control">
      </div>
    </form>
  </div>
  <div class="modal-footer">

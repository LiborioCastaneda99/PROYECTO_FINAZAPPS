...
<head>
    ...
    <title>Informe por día | FINAZAPPS</title>
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Estado', 'Valor'],  <?php
            echo "['Ingresos', ".$valorTotal_Ingresos_Dia."],
            ['Egresos', ".$valorTotal_Egresos_Dia."],";
            ?>
            ]);

        var options = {
          title: 'Informe estadistico financiero, totales de ingresos y egresos del día',
          width: '100%',
          height: '400px'
      };
 ...
 <div class="wrapper">
    ...
    <div id="content">
     ...
     <div class="container text-center">
        ...
        <h3>[Informe de totales por día]</h3>
        <h4><?php if (is_null($FechaDia)) {
        }else{
            echo $FechaDia;
        } ?></h4>
        <form action="informe-total-x-dia.php" method="POST">
            <div class="row pb-2 text-left">
                <div class="col-md-6">
                    <label for="">Fecha Inicio</label>
                    <input type="date" class="form-control" id="FechaDia" name="FechaDia" value="<?php echo date("Y-m-d");?>">
                </div>
                <div class="col-md-3">
                    <label>Seleccione</label><br>
                    <input type="checkbox" class="form-control form" name="">
                </div> 
                <div class="col-md-3">

                    <label for="">Seleccione la forma de pago</label>
       ...
       <div class="table-responsive  small table-wrapper-scroll-y my-custom-scrollbar mb-4">
         <hr>
         <h3>[Total de Ingresos por día]</h3>
    ...
    <div class="container mb-4">
        <div class="row bg-dark p-2 text-white" style="border-radius: 5px;">
            ...
            <input type="text" id="" name="" class="form-control col-sm text-center" readonly value="<?php if($valorTotal_Ingresos_Dia<='0'){
                echo '$0';
                }else {
                    echo '$'.$valorTotal_Ingresos_Dia;
                }?>">
            </div>
        </div>

        <hr>
        <h3>[Total de Egresos por día]</h3>
        <div class="table-responsive  small table-wrapper-scroll-y my-custom-scrollbar mb-4">
            <table class="table table-hover">
                <thead class="thead-dark">
                    <tr>
    ...
    <div class="container mb-4">
        <div class="row bg-dark p-2 text-white" style="border-radius: 5px;">
            <h5 class="col-sm">Total Generado</h5>  
            <input type="text" id="" name="" class="form-control col-sm text-center" readonly value="<?php if($valorTotal_Egresos_Dia<='0'){
                echo '$0';
                }else {
                    echo '$'.$valorTotal_Egresos_Dia;
                }?>">
            </div>
        </div>
